	...
	<body>
		...
		<table border="0.5">
			...
			<?php
				...
				$sql="select * from tabelacad where perfil = '$perfil' AND regiaodeProcura = '$cidade'";
				...
				while($reg=mysqli_fetch_row($res)){
					...
					echo "<tr>";
					echo "<td>$nome<td/>$cpf<td/>$tel<td/>$rpr<td/>$perfil<td/>$sexo";
					echo "</tr>";
					echo "<tr>";
		...
		<table/>
			...
			<a style="font-family: calibri" href="formaux.html" target="_self">Voltar formulario</a>
